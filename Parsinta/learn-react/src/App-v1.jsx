    ...
    <div className={'bg-slate-900 tracking-tight grid place-content-center min-h-screen'}>
      ...
      <div className='max-w-2xl gap-4 w-full mb-11 text-white antialiased flex items-center justify-center'>
        <Card>
          ...
          <Card.Body>
            Minim aliqua enim exercitation culpa qui nostrud. Consequat proident dolore exercitation aute. Deserunt qui dolore dolore commodo commodo
            adipisicing sit tempor sunt. Et pariatur mollit veniam nulla deserunt nostrud qui. Consectetur incididunt minim laboris velit nisi consectetur
            officia in.
          </Card.Body>
